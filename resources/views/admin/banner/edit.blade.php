        ...
        <div class="col-md-6 mt-4">
            <form action="{{route('banner.update', $banner->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input name="name" value="{{ $banner->name }}" type="text" class="form-control" id="inputName" placeholder="Ex: banner promoção natal" required>
                </div>
                <div class="form-group">
                    <img id="inputPreview" src="/assets/image/banner/uploads/{{ $banner->image }}" class="img-fluid" alt="imagem do produto" style="width: 150px; height: 100px;">
